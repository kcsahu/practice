...
public class WordLadderI {
    ...
    public static void main(String[] args) {
        ...
        int res = ladderLength("cet", "ism", new ArrayList<>(Stream.of("kid", "tag", "pup", "ail", "tun", "woo", "erg", "luz", "brr", "gay", "sip", "kay", "per", "val", "mes",
                ...
                "pox", "vow", "got", "meg", "zoe", "amp", "ale", "bud", "gee", "pin", "dun", "pat", "ten", "mob").toList()));
